...
During the course of 4 weeks we were able to deliver a prototype for a prescription drugs delivery web app in PHP (Symfony) & React JS utilizing Agile tenets and scrum approach in a fully remote setting. We worked in sprints and made full use of collaborative tools & methods (slack, discord, pair-programming, code review, git & github...), we applied newly gained skills while learning a myriad of new ones along the way and we were able to meet deadlines effectively. 
<br><br>
